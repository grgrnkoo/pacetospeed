...
export default function HowToRunFaster5KPage() {
  return (
    <div className="w-full">
      <article className="max-w-3xl mx-auto py-8 sm:py-12 px-4"><ArticleStructuredData slug="how-to-run-faster-5k" />
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8 space-y-4 sm:space-y-8">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">1. Run One Tempo per Week</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">2. Add Short Intervals</h2>
            <p className="text-stone-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">3. Build a Real Warmup</h2>
            <p className="text-stone-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">4. Practice Pacing</h2>
            <p className="text-stone-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">5. Strength Train Once Weekly</h2>
            <p className="text-stone-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">6. Keep Easy Runs Easy</h2>
            <p className="text-stone-800 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">7. Race or Time Trial Regularly</h2>
            <p className="text-stone-800 leading-relaxed">
