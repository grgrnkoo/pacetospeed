...
export default function RunningWarmUpCoolDownPage() {
  return (
    <div className="min-h-screen">
      <article className="max-w-3xl mx-auto py-12 px-4"><ArticleStructuredData slug="running-warm-up-cool-down" />
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-stone-800 mb-4">5-Minute Warm-Up</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-stone-800 mb-4">5-Minute Cool-Down</h2>
            <ul className="list-disc list-inside space-y-2 text-stone-800 ml-4">
