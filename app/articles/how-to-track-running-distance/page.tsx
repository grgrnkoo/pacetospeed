...
export default function HowToTrackRunningDistancePage() {
  return (
    <div className="w-full">
      <article className="max-w-3xl mx-auto py-8 sm:py-12 px-4"><ArticleStructuredData slug="how-to-track-running-distance" />
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8 space-y-4 sm:space-y-8">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">Outdoor Options</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">Indoor Options</h2>
            <ul className="list-disc list-inside space-y-2 text-stone-800 ml-4">
