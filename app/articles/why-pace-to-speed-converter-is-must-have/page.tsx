...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://pacetospeed.xyz/articles/why-pace-to-speed-converter-is-must-have',
  },
  openGraph: {
    title: 'Why a Pace-to-Speed Converter Is a Must-Have Tool for Runners',
    ...
    type: 'article',
    images: [{ url: '/api/og?slug=why-pace-to-speed-converter-is-must-have', width: 1200, height: 630, alt: '' }],
      ...
      <article className="max-w-3xl mx-auto py-8 sm:py-12 px-4"><ArticleStructuredData slug="why-pace-to-speed-converter-is-must-have" />
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8 space-y-4 sm:space-y-8">
          ...
          <section>
            ...
            <p className="text-stone-800 leading-relaxed mb-4 font-semibold">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-stone-50 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 text-stone-800 ml-4">
