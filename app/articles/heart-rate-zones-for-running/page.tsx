...
export default function HeartRateZonesForRunningPage() {
  return (
    <div className="w-full">
      <article className="max-w-3xl mx-auto py-8 sm:py-12 px-4"><ArticleStructuredData slug="heart-rate-zones-for-running" />
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-8 space-y-4 sm:space-y-8">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">Estimate Your Max Heart Rate</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">Zone Breakdown</h2>
          ...
          <section className="border-t border-stone-200 pt-6">
            <h2 className="text-xl sm:text-2xl font-semibold text-stone-800 mb-4">How to Use Zones</h2>
