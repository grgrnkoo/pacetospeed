    ...
    <div className="min-h-screen">
      <article className="max-w-3xl mx-auto py-12 px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-stone-800 mb-4">Target Pace Formula</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-stone-800 mb-4">Example: Sub-50 10K</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-stone-800 mb-4">Example: 2:00 Half Marathon</h2>
            <div className="bg-stone-50 rounded-lg p-6 border-l-4 border-stone-800">
              <ol className="list-decimal list-inside space-y-2 text-stone-800 ml-4 text-sm">
